            ...
            <div class="card" style="height:auto;">
                ...
                <div class="card-body">
                    ...
                    @endif
                      ...
                      <form method='POST' enctype="multipart/form-data" action="{{url('updatehostel')}}"> <!--acton insertpdt "routes(web.php)" to the controller-->
                     <input type="hidden" id="name"  name="id" value="{{$items->id}}">
                      @csrf
                      <!-- Hostel name -->
                      <div  class="form-group row">
                      <label for="hostel_name" class="col-md-4 col-form-label text-md-right">{{ __('Hostel name') }}</label>
                             <div class="col-md-3">
                      <input name='hostel_name' value="{{$items->hostel_name}}" id="hostel_name" type="text" class="form-control  required  autofocus">
                      </div>
                            </div>
                            <!--  district city-->
                      <div class="form-group row">
                      <label for="district" class="col-md-4 col-form-label text-md-right">{{ __('District') }}</label> 
                            <div class="col-md-2">
                            <input name='district' value="{{$items->district}}" id="district" type="text"  class="form-control  required  autofocus">
                            </div>
                            <label for="city" class="col-md-1 col-form-label text-md-right">{{ __('City') }}</label>
                            <div class="col-md-2">
                            <input name='city' value="{{$items->city}}" id="city" type="text" class="form-control  required  autofocus">
                            </div>
                      </div>  
                         <!-- address -->
                      <div class="form-group row">
                      <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('address') }}</label> 
                            <div class="col-md-4">
                           <textarea   name="address" rows="4" cols="25"  class="form-control  required  autofocus">{{$items->address}}</textarea>
                            </div>
                      </div>
                        <!-- description -->
                      <div class="form-group row">
                      <label for="description" class="col-md-4 col-form-label text-md-right">{{ __('description') }}</label> 
                            <div class="col-md-4">
                           <textarea name="description"  rows="4" cols="25"  class="form-control  required  autofocus">{{$items->description}}</textarea>
                            </div>
                      </div>
                      ...
                      <label for="mobile" class="col-md-4 col-form-label text-md-right">{{ __('Mobile Number') }}</label>
                             <div class="col-md-3">
                      <input name='mobile' value="{{$items->mobile}}" id="mobile" type="tel"  class="form-control  required  autofocus">
                      </div>
                            </div>
                      <!-- Bed Capacity -->
                      <div  class="form-group row">
                      <label for="bed capacity" class="col-md-4 col-form-label text-md-right">{{ __('Bed Capacity') }}</label>
                             <div class="col-md-1">
                      <input  name='bedcapacity' value="{{$items->bedcapacity}}" id="bed_capacity" type="number" class="form-control  required  autofocus">
                      </div>
                            </div>
                            <!-- fee -->
                            <div class="form-group row">
                      <label for="fee" class="col-md-4 col-form-label text-md-right">{{ __('fee') }}</label> 
                            <div class="col-md-2">
                            <input  name='fee' value="{{$items->fee}}" id="fee" type="number"  class="form-control  required  autofocus">
                            </div>
                      </div>
                    <!-- chechbox -->
                    <div class="form-group row">
                       ...
                       <div class="col-md-4 row">
                        <!-- permitted for -->
                        <div class="col-md-4">
                        <input name="men" type="checkbox"  id="men" value="{{$items->men}}">
